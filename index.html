...
<?php require_once 'includes/header.inc.php'; ?>
        ...
        <!-- HOME START-->
        <section class="bg-home" style="background-image:url('images/bg-2.jpg')" id="home">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-6">
                               <div class="title-heading">
                                    <h1 class="heading text-white mb-1"><span class="element" data-elements=" Coming Soon, Coming Soon"></span></h1>

                                    <h1 class="heading text-white mb-3"><span class="element" data-elements=" Doctor In Your Pocket, Quality Healthcare At Your Convenience"></span></h1>
                                    <p class="para-desc mx-auto text-white-50">Talk to a doctor online anytime, anywhere through chat, video & audio call. You can consult with any of the licensed medical doctors on MexD.</p>
                                    <div class="mt-4 pt-2">
                            ...
                            <div class="col-lg-5 col-md-6 mt-4 pt-2">
                                <div class="home-img text-md-right">
                                    <img src="images/home/mobile04.png" class="img-fluid mover-img" alt="">
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </div><!--end container--> 
        ...
        <section class="section">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-5">
                        <img src="images/ab01.png" class="img-fluid" data-aos="fade-right" alt="">
                    </div><!--end col-->

                    <div class="col-md-7 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div class="about-app ml-lg-4">
                            <i class="mdi mdi-material-design text-custom h2"></i>
                            <h4 class="title text-uppercase mt-2 mb-3">Good, Smart features</h4>
                            <p class="text-muted">Packaged with the smart and reliable way of maintaining your health records for you.</p>
                ...
                <div class="row mt-5 align-items-center">
                    <div class="col-md-7 mt-4 mt-sm-0 pt-2 pt-sm-0 order-2 order-md-1">
                        <div class="about-app mr-lg-4">
                            ...
                            <h4 class="title text-uppercase mt-2 mb-3">All-in-One Hospital App</h4>
                            <p class="text-muted">Book, schedule and run tests from anywhere and at your convenience.</p>
                            <a href="javascript:void(0)" class="btn btn-custom mt-2">Learn More</a>
                        </div>
                    </div><!--end col-->
                ...
                <div class="row services align-items-center">
                    ...
                    <div class="col-lg-4 mt-4 pt-2 core-service-img">
                        <div class="ml-lg-4 mr-lg-4">
                            <img src="images/features.png" class="img-fluid mx-auto" data-aos="zoom-in-down" alt="">
                        </div>
                    </div><!--end col-->
                ...
                <div class="row" id="counter">
                    <div class="col-lg-3 col-md-6 p-4">
                        <div class="counter-box text-center">
                            ...
                            <h5 class="counter-head text-white">Licensed Doctors</h5>
                        </div><!--end counter box-->
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 p-4">
                        <div class="counter-box text-center">
                            ...
                            <h5 class="counter-head text-white">Active Subscribers</h5>
                        </div><!--end counter box-->
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 p-4">
                        <div class="counter-box text-center">
                            ...
                            <h5 class="counter-head text-white">Scheduled Appointments</h5>
                        </div><!--end counter box-->
                    </div><!--end col-->
                    ...
                    <div class="col-lg-3 col-md-6 p-4">
                        <div class="counter-box text-center">
                            ...
                            <h5 class="counter-head text-white">Completed Consultations</h5>
                        </div><!--end counter box-->
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center">
                            ...
                            <p class="text-muted mx-auto para-desc mb-0">With essentric user interfaces for ease of access.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
                ...
                <div class="row justify-content-center mt-4 pt-2">
                    <div class="col-12 swiper-container">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide"><img src="images/sc/1.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/2.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/3.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/4.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/5.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/6.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/7.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/8.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/9.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/10.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/11.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/12.png" class="img-fluid" alt=""></div>
                            <div class="swiper-slide"><img src="images/sc/13.png" class="img-fluid" alt=""></div>
                        </div>    
                        <!-- Add Arrows  -->
        ...
        <!-- Testimonail Start -->
        <section class="section" id="review" style="background:url('images/testi.jpg') fixed center center;">
            <div class="bg-overlay"></div>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        ...
                        <div id="twitter-testi" class="owl-carousel testi-review">
                            <div class="testimonial text-center ml-3 mr-3">
                                <div class="content-review">
                                    ...
                                    <h5 class="name mb-1 mt-3 text-light">Dr. Philip Eke</h5>
                                    <img src="images/client/review2.jpg" class="img-fluid rounded-pill img-thumbnail mt-3" alt="">
                                </div>
                            </div><!--end content-->
                            <div class="testimonial text-center ml-3 mr-3">
                                <div class="content-review">
                                    ...
                                    <h5 class="name mb-1 mt-3 text-light">Uzo Ubah</h5>
                                    <img src="images/client/review1.jpg" class="img-fluid rounded-pill img-thumbnail mt-3" alt="">
                                </div>
                            </div><!--end content-->
                            <div class="testimonial text-center ml-3 mr-3">
                                <div class="content-review">
                                    ...
                                    <h5 class="name mb-1 mt-3 text-light">Mazi Thomas Okeke</h5>
                                    <img src="images/client/review3.jpg" class="img-fluid rounded-pill img-thumbnail mt-3" alt="">
                                </div>
                            </div><!--end content-->
                        </div>
                    </div> <!-- end col -->
                ...
                <!-- <div class="row mt-5 text-center">
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/1.png" class="img-fluid" alt=""></div>
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/2.png" class="img-fluid" alt=""></div>
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/3.png" class="img-fluid" alt=""></div>
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/4.png" class="img-fluid" alt=""></div>
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/5.png" class="img-fluid" alt=""></div>
                    <div class="col-lg-2 col-md-4 col-6"><img src="images/client/6.png" class="img-fluid" alt=""></div>
                </div> -->
            </div><!--end container fluid-->
        </section><!--end section-->
        <!-- Testimonail End -->
        ...
        <!-- Price STart -->
        <section class="section" id="price" style="background:url('images/logo/Medx logo-03-03.jpg') fixed center center;background-size: contain;background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <div class="section-title text-center">
                            <i class="mdi mdi-download text-custom h2"></i>
                            <h4 class="title text-uppercase text-white mt-3 mb-5">App Download</h4>
                            <p class="mx-auto para-desc mb-0 text-white">Head on to download MexD App fro your various platform.</p>
                        </div>
                    </div><!--end col-->
                </div><!--end row-->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 p-0">
                        <div class="map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d92181.08836756031!2d11.170756608169997!3d43.779936659948945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x132a541847050f9d%3A0xb662ac3eb7b58c6b!2sPiazza+Della+Libert%C3%A0!5e0!3m2!1sen!2sin!4v1562932112256!5m2!1sen!2sin" style="border: 0;" allowfullscreen></iframe>
                        </div><!--end map-->
                    </div><!--end col-->
                </div><!--end row-->
            </div><!--end container-->
